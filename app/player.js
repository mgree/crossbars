...
var author$project$Main$defaultModel = {focused: false, mode: author$project$Main$NoPuzzle, msg: elm$core$Maybe$Nothing, playedPuzzles: _List_Nil, selectedPuzzle: elm$core$Maybe$Nothing};
...
var author$project$Main$getFocus = A2(
...
var author$project$Main$init = function (json) {
	...
	return _Utils_Tuple2(model, author$project$Main$getFocus);
};
				...
				selectedPuzzle: A2(
					...
					function (idx) {
						return elm$core$List$head(
							A2(elm$core$List$drop, idx, model.playedPuzzles));
					},
					mIndex)
			});
	});
...
var author$project$Puzzle$sameBlank = F2(
	function (b1, b2) {
		return _Utils_eq(
			A2(elm$core$Debug$log, 'b1', b1).quoteWordLengths,
			A2(elm$core$Debug$log, 'b2', b2).quoteWordLengths) && A2(
			elm$core$List$all,
			elm$core$Basics$identity,
			A3(elm$core$List$map2, elm$core$Basics$eq, b1.clues, b2.clues));
	});
...
var author$project$Main$clearPuzzlesLike = F2(
	function (gs, model) {
		return A2(
			author$project$Main$withPlayedPuzzles,
			A2(
				...
				A2(
					...
					A2(
						elm$core$Basics$composeL,
						elm$core$Basics$not,
						author$project$Puzzle$sameBlank(gs.puzzle)),
					function ($) {
						return $.puzzle;
					}),
				model.playedPuzzles),
...
var author$project$Main$trySaveCurrentPuzzle = function (model) {
	...
	if (_n0.$ === 'NoPuzzle') {
		...
		return A2(
			...
			A2(author$project$Main$clearPuzzlesLike, old, model));
	}
};
...
var author$project$Puzzle$MissingClueNumbers = function (a) {
	return {$: 'MissingClueNumbers', a: a};
};
var author$project$Puzzle$QuoteLengthMismatch = F2(
	function (a, b) {
		return {$: 'QuoteLengthMismatch', a: a, b: b};
	});
...
var author$project$Puzzle$isValidBlank = function (puzzle) {
	var qwlLength = elm$core$List$sum(puzzle.quoteWordLengths);
	var quoteLength = elm$core$List$length(puzzle.quote);
	var numberCounts = A3(
		elm$core$List$foldr,
		F2(
			function (_n2, d) {
				var index = _n2.a;
				var qIndex = _n2.b;
				return A3(author$project$Util$updateCons, qIndex, index, d);
			}),
		elm$core$Dict$empty,
		A2(
			...
			A2(
				...
				F2(
					function (index, clue) {
						return _Utils_Tuple2(index, clue.answer);
					}),
				puzzle.clues)));
	var dupIndices = elm$core$Dict$toList(
		A2(
			elm$core$Dict$filter,
			F2(
				function (_n0, idxs) {
					return elm$core$List$length(idxs) !== 1;
				}),
			numberCounts));
	var correctNumbers = A2(
		elm$core$List$range,
		0,
		elm$core$List$length(puzzle.quote) - 1);
	var actualNumbers = elm$core$List$sort(
		A2(
			elm$core$List$concatMap,
			function ($) {
				return $.answer;
			...
			puzzle.clues));
	var missingNumbers = A2(
		elm$core$List$filter,
		function (num) {
			return !A2(elm$core$List$member, num, actualNumbers);
		},
		correctNumbers);
	return _Utils_ap(
		_Utils_eq(quoteLength, qwlLength) ? _List_Nil : _List_fromArray(
			[
				A2(author$project$Puzzle$QuoteLengthMismatch, quoteLength, qwlLength)
			]),
		_Utils_ap(
			elm$core$List$isEmpty(missingNumbers) ? _List_Nil : _List_fromArray(
				[
					author$project$Puzzle$MissingClueNumbers(missingNumbers)
				]),
			elm$core$List$isEmpty(dupIndices) ? _List_Nil : _List_fromArray(
				[
					author$project$Puzzle$DuplicateClueNumbers(dupIndices)
				])));
};
...
var author$project$Puzzle$problemToString = function (p) {
	switch (p.$) {
		case 'QuoteLengthMismatch':
			var q = p.a;
			var qwl = p.b;
			return 'quote is of length ' + (elm$core$String$fromInt(q) + (' but quote word divisions indicate a quote of length ' + elm$core$String$fromInt(qwl)));
		case 'MissingClueNumbers':
			var nums = p.a;
			return 'missing clue numbers (' + (A2(
				elm$core$String$join,
				', ',
				A2(elm$core$List$map, elm$core$String$fromInt, nums)) + ')');
		default:
			var nums = p.a;
			return 'duplicate clue numbers (' + (A2(
				elm$core$String$join,
				'; ',
				A2(
					elm$core$List$map,
					function (_n1) {
						var qIndex = _n1.a;
						var clueIndices = _n1.b;
						return elm$core$String$fromInt(qIndex) + (' in ' + A2(
							elm$core$String$join,
							',',
							A2(elm$core$List$map, author$project$Puzzle$letterFor, clueIndices)));
					},
					nums)) + ')');
	}
};
var author$project$Main$loadPuzzle = F2(
	function (gs, model) {
		var _n0 = author$project$Puzzle$isValidBlank(gs.puzzle);
		if (!_n0.b) {
			return author$project$Main$trySaveCurrentPuzzle(
				A2(
					author$project$Main$clearPuzzlesLike,
					gs,
					...
					return author$project$Main$andSave(
						function () {
							...
							if (_n2.$ === 'Err') {
								...
								var gs = _n2.a;
								return A2(author$project$Main$loadPuzzle, gs, model);
							}
						}());
				case 'LoadSavedPuzzle':
					var _n3 = _n0.b;
					var _n4 = model.selectedPuzzle;
					if (_n4.$ === 'Nothing') {
						...
						return author$project$Main$andSave(
							A2(
								...
								gs,
								A2(author$project$Main$asSelectedPuzzleIn, model, elm$core$Maybe$Nothing)));
					}
				case 'SelectSavedPuzzle':
					var sIndex = _n0.b.a;
					return _Utils_Tuple2(
						A2(
...
var author$project$Main$LoadSavedPuzzle = {$: 'LoadSavedPuzzle'};
var author$project$Main$RequestPuzzleFile = {$: 'RequestPuzzleFile'};
var author$project$Main$SelectSavedPuzzle = function (a) {
	return {$: 'SelectSavedPuzzle', a: a};
};
var elm$core$String$words = _String_words;
var author$project$Main$gameStateDescription = function (gs) {
	var abbrev = function (clue) {
		return A2(
			elm$core$String$join,
			' ',
			A2(
				elm$core$List$take,
				2,
				elm$core$String$words(clue.hint))) + '...';
	};
	var _n0 = A2(elm$core$List$take, 2, gs.puzzle.clues);
	if (!_n0.b) {
		return '???';
	} else {
		if (!_n0.b.b) {
			...
			var _n1 = _n0.b;
			var clue2 = _n1.a;
			return 'A. ' + (abbrev(clue1) + ('; ' + ('B. ' + abbrev(clue2))));
		}
	}
};
			...
			function (alt, ctrl, meta, key) {
				...
				return (ctrl && ((!(alt || meta)) && _Utils_eq(
					...
					A2(
						...
						elm$core$Maybe$Just(author$project$Main$Right))) : (((!modified) && _Utils_eq(
					c,
					_Utils_chr(' '))) ? elm$core$Result$Ok(
					A2(author$project$Main$SetCursor, elm$core$Maybe$Nothing, elm$core$Maybe$Nothing)) : elm$core$Result$Err(keyDesc)));
			}),
...
var author$project$Puzzle$completedBlank = function (b) {
	return A2(
		elm$core$List$all,
		function (mc) {
			return !_Utils_eq(mc, elm$core$Maybe$Nothing);
		},
		b.quote);
};
							...
							[
								...
								_List_fromArray(
									[
										...
										elm$html$Html$Events$onInput(author$project$Main$SelectSavedPuzzle)
									]),
								A2(
									elm$core$List$cons,
									A2(
									...
									function () {
										var saved = A2(
											elm$core$List$drop,
											1,
											A2(elm$core$List$indexedMap, elm$core$Tuple$pair, model.playedPuzzles));
										var grouping = F2(
											function (name, l) {
												return elm$core$List$isEmpty(l) ? _List_Nil : _List_fromArray(
													[
														A2(
															...
															function (_n1) {
																...
																return A2(
																	...
																	_List_fromArray(
																		[
																			elm$html$Html$text(
																			author$project$Main$gameStateDescription(savedPuzzle))
																		]));
															},
															l))
													]);
										...
										var _n0 = A2(
											...
											A2(
												...
												A2(
													...
													author$project$Puzzle$completedBlank)),
											saved);
										var completed = _n0.a;
										var playing = _n0.b;
										return _Utils_ap(
											A2(grouping, 'In progress', playing),
											A2(grouping, 'Completed', completed));
									}())),
								A2(
								elm$html$Html$input,
								_List_fromArray(
									[
										...
										elm$html$Html$Attributes$id('loadsavedpuzzle'),
										elm$html$Html$Attributes$value('Load puzzle'),
										elm$html$Html$Events$onClick(author$project$Main$LoadSavedPuzzle)
									]),
								_List_Nil),
								A2(
								elm$html$Html$input,
								_List_fromArray(
									[
										elm$html$Html$Attributes$type_('button'),
										elm$html$Html$Attributes$id('loadpuzzlefile'),
